...
load(fullfile(homedir,'UnitsInformation_LaserOnOff.mat'),'UnitsInformation');
...
for iGroup = 1:numel(Group)
    ...
    for iUnit = 1:size(UnitsInformation,1)
        ...
        tempFR_S1 = UnitsInformation{iUnit,17}.(tempGroup); % individual neuron's FR of S1 trials
        tempFR_S2 = UnitsInformation{iUnit,18}.(tempGroup); % individual neuron's FR of S2 trials
