...
%==========================================================================    
    ...
    methods 
        ...
        function [fp,XTr_normalized] = set_properties_with_training_data(fp, XTr, tilda_junk)  
            % inputs should really be (fp, XTr, YTr), matlab creators really do not understard OOP
            %function [fp XTr_normalized] = set_properties_with_training_data(fp, XTr, ~)  
            % changed this line so that the toolbox will be compatible with older versions of matlab  
