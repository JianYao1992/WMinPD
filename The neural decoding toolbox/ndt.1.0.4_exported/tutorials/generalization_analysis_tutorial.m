...
toolbox_dir = 'D:\results\matlab Codes\Population Analysis\The neural decoding toolbox\ndt.1.0.4_exported/';
raster_file_directory_name = 'Zhang_Desimone_7objects_raster_data/';

cd('D:\results\matlab Codes\Population Analysis\The neural decoding toolbox\ndt.1.0.4_exported/')
